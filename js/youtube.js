$(document).ready(function() {
  ...
  function GetVids() {
    ...
    fetch(
      "https://youtube-intg.herokuapp.com/api/v1/getPlaylistVideos",
      requestOptions
    )
      ...
      .then(result => {
        ...
        for (i = 0; i < j; i++) {
          output += `<div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class='barlow-medium'></h5>
                                        <p class='barlow-extralight'></p>
                                    </div>
                                </div>`;
        }
        $(".loader").hide();
      ...
      .then(result => {
        ...
        for (i = 0; i < j; i++) {
          output += `<div class="card playlist-card">
                                    <iframe width="100%" height="300" src="https://www.youtube.com/embed/videoseries?list" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    <div class="card-body">
                                        <h5 class='barlow-medium'></h5>
                                        <p class='barlow-extralight'></p>
        ...
        $(".playlist-videos-btn").on("click", function() {
          ...
          fetch(
            "https://youtube-intg.herokuapp.com/api/v1/getPlaylist?playlistId=" +
              id,
            requestOptions
          )
            .then(response => response.json())
            .then(result => {
              ...
              for (i = 0; i < j; i++) {
                output += `<div class="card">
                                                ...
                                                <div class="card-body">
                                                    <h5 class='barlow-medium'></h5>
                                                    <p class='shave barlow-extralight'></p>
                                                </div>
                                            </div>`;
              }
